...
%Inserting Equation~\ref{eq:vri1} to~\ref{eq:qi} we see that to minimize $Q_i$ 
...
%find $\alpha_i, \beta_i$ and $\gamma_i$, we formulate it as the optimization 
%problem:
...
\begin{figure*}[t]
	...
	\hspace{-1cm}
	\subfloat["flat" 
	matrices]{\includegraphics[width=0.33\textwidth]
...
\begin{table}[h!]
	...
	\begin{tabular}{@{}l|ll@{}}
		...
		%& $n,m$&Numbers of vertices and edges in $G$; $|V| = 
		%n, |E| = m$.\\
