...
using ms_t = std::chrono::milliseconds;
  ...
  gpu::blas_api::OperationType get_blas_operation(char trans) {
    gpu::blas_api::OperationType op = trans == 'T'
      ?
      gpu::blas_api::operation::Transpose
      :
      (trans == 'C'
       ?
       gpu::blas_api::operation::ConjugateTranspose
       :
  ...
  gpu::blas_api::StatusType cublas_gemm_wrapper(gpu::blas_api::HandleType handle,
    ...
    return gpu::blas_api::sgemm(handle, op_a, op_b, m, n, k,
  ...
  gpu::blas_api::StatusType cublas_gemm_wrapper(gpu::blas_api::HandleType handle,
    ...
    return gpu::blas_api::dgemm(handle, op_a, op_b, m, n, k,
                                alpha, a, ld_a, b, ld_b, beta, c, lld_c);
  }
  ...
  gpu::blas_api::StatusType cublas_gemm_wrapper(gpu::blas_api::HandleType handle,
    ...
    return gpu::blas_api::cgemm(handle, op_a, op_b, m, n, k,
                                reinterpret_cast<const gpu::blas_api::ComplexFloatType*>(alpha),
                                reinterpret_cast<const gpu::blas_api::ComplexFloatType*>(a), ld_a,
                                reinterpret_cast<const gpu::blas_api::ComplexFloatType*>(b), ld_b,
                                reinterpret_cast<const gpu::blas_api::ComplexFloatType*>(beta),
                                reinterpret_cast<gpu::blas_api::ComplexFloatType*>(c), lld_c);
  }
  ...
  gpu::blas_api::StatusType cublas_gemm_wrapper(gpu::blas_api::HandleType handle,
    ...
    return gpu::blas_api::zgemm(handle, op_a, op_b, m, n, k,
                                reinterpret_cast<const gpu::blas_api::ComplexDoubleType*>(alpha),
                                reinterpret_cast<const gpu::blas_api::ComplexDoubleType*>(a), ld_a,
                                reinterpret_cast<const gpu::blas_api::ComplexDoubleType*>(b), ld_b,
                                reinterpret_cast<const gpu::blas_api::ComplexDoubleType*>(beta),
                                reinterpret_cast<gpu::blas_api::ComplexDoubleType*>(c), lld_c);
  }
#endif
    ...
    */
    ...
    auto status = cublas_gemm_wrapper((*gpu_ctx).get_gpu_context().get_blas_handle(0),
                                      'N', 'N',
                                      m, n, k,
                                      &alpha,
                                      matrixA,
                                      ...
                                      matrixC,
                                      m);
    //gpu::gpu::blas_api::check_blas_status(status);
#endif
    /*
    if (rank == 0) {
