...
void Buffer::initialize_buffers() {
    ...
    buffers_ = std::vector<std::vector<double, allocator<double>>>(buff_sizes.size()+1, std::vector<double, allocator<double>>());
    buffers_[0].resize(mapper_->initial_size());
    //buffers_[0] = std::vector<double, allocator<double>>(mapper_->initial_size());
...
std::vector<double, allocator<double>>& Buffer::buffer() {
...
const std::vector<double, allocator<double>>& Buffer::buffer() const {
    return buffers_[current_buffer_];
}
...
std::vector<double, allocator<double>>& Buffer::initial_buffer() {
    return buffers_[0];
}

const std::vector<double, allocator<double>>& Buffer::initial_buffer() const {
    return buffers_[0];
}
...
std::vector<double, allocator<double>>& Buffer::operator[](const std::vector<double, allocator<double>>::size_type index) {
    return buffers_[index];
}

std::vector<double, allocator<double>> Buffer::operator[](const std::vector<double, allocator<double>>::size_type index) const {
    return buffers_[index];
}
