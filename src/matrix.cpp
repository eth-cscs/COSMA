...
std::vector<double, allocator<double>>& CarmaMatrix::buffer() {
    return buffer_.buffer();
}

const std::vector<double, allocator<double>>& CarmaMatrix::buffer() const {
    return buffer_.buffer();
}
...
std::vector<double, allocator<double>>& CarmaMatrix::matrix() {
    //return matrix_;
    return buffer_.initial_buffer();
}

const std::vector<double, allocator<double>>& CarmaMatrix::matrix() const {
    //return matrix_;
    return buffer_.initial_buffer();
}
